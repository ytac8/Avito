...
class Preprocessor():
    ...
    def _description_preprocess(self):
        ...
        for df in [self.train_df, self.test_df]:
            df['description'].fillna('неизвестный', inplace=True)
            df['title'].fillna('неизвестный', inplace=True)
    ...
    def _get_counts_feature(self):
        ...
        # norm = Normalizer()
        # train_title_counts = norm.fit_transform(train_title_counts)
        # test_title_counts = norm.fit_transform(test_title_counts)
        # train_desc_counts = norm.fit_transform(train_desc_counts)
        # train_desc_counts = norm.fit_transform(train_desc_counts)
